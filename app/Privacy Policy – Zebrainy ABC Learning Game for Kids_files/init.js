...
jQuery( document ).ready(function( $ ) {
    ...
    /*Sound and Video Option*/
    if($("#home_video").length > 0){
        $(".video-option .fa-play").click(function(){
            $('.video-option .fa-play').css('visibility', 'hidden');    
            $('.video-option .fa-pause').css('visibility', 'visible');  
            $('.video-option .fa-play').css('opacity', '0');
            $('.video-option .fa-pause').css('opacity', '1');
            $('#home_video').get(0).play();
        });
        $(".video-option .fa-pause").click(function(){
            $('.video-option .fa-play').css('opacity', '1');
            $('.video-option .fa-pause').css('opacity', '0');
            $('.video-option .fa-play').css('visibility', 'visible');   
            $('.video-option .fa-pause').css('visibility', 'hidden');   
        ...
        $('#home_video').get(0).onended = function() {
            $('.video-option .fa-play').css('opacity', '1');
            $('.video-option .fa-pause').css('opacity', '0');
            $('.video-option .fa-play').css('visibility', 'visible');   
            $('.video-option .fa-pause').css('visibility', 'hidden');   
