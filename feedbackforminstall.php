...
// Version: Free Feedback Form V1 - Installer
...
// THE SOFTWARE.
define('INSTALLFILE', 'feedbackforminstall.php');
define('CONFIGFILE', 'feedbackformsettings.php');
define('ABSPATH', dirname(__FILE__) . '/' );

error_reporting( E_CORE_ERROR | E_CORE_WARNING | E_COMPILE_ERROR | E_ERROR | E_WARNING | E_PARSE | E_USER_ERROR | E_USER_WARNING | E_RECOVERABLE_ERROR );

$install_complete = '<br />Installation complete. <a href="feedbackform.htm">Visit your form</a>. <br /><br />To reinstall, delete the file: '.CONFIGFILE.' then run <a href="'.INSTALLFILE.'">this installer again</a>.<br /><br />';
...
<html>
	...
	<div class="feedbackformheader">Installation Form</div>
...
switch($step) {
  ...
  case "1":
      ...
      ?>
			...
			<form name="feedbackform" method="post" action="<?php echo INSTALLFILE; ?>" onsubmit="return validate.check(this)">
			<input type="hidden" name="step" value="2">
			<table width="450px">
			<tr>
			 <td colspan="2">
			 
			 <div class="feedbackformmessage">
			...
			<tr>
			 ...
			 <td valign="top">
			  <input type="text" name="subject" id="subject" maxlength="100" value="Feedback form" style="width:140px"> + Forms Subject
			 </td>
			 </tr>
			...
			<tr>
			 ...
			 <td valign="top">
			  <input type="text" name="answer" id="answer" maxlength="100" value="10" style="width:180px">
			 </td>
